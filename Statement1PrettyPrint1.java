        ...
        switch (this.kind()) {
            case BLOCK: {
                ...
                while (this.lengthOfBlock() > 0) {
                    ...
                    s1.addToBlock(s1.lengthOfBlock(), s);
                }
            ...
            case IF: {
                ...
                StatementKernel.Condition c = this.disassembleIf(s1);
            ...
            case WHILE: {
                Statement s1 = this.newInstance();
                StatementKernel.Condition c = this.disassembleWhile(s1);
